        ...
        <div class="max-w-7xl mx-auto px-4">
                ...
                <nav class="hidden md:flex items-center gap-0.5 shrink-0">
                        ...
                        @if(Auth::user()->hasEvents())
                            <a href="{{ route('organizer.dashboard') }}"
                               class="flex flex-col items-center gap-0.5 px-3 py-2 text-xs text-gray-500
                                      hover:text-indigo-600 hover:bg-indigo-50 rounded-xl transition group">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                    class="flex items-center justify-center w-9 h-9 rounded-full
                                           hover:ring-2 hover:ring-indigo-300 transition overflow-hidden
                    ...
                    @else
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                    class="flex items-center justify-center w-9 h-9 rounded-full
                                           bg-gray-100 hover:bg-indigo-50 hover:text-indigo-600
                                           text-gray-500 transition hover:ring-2 hover:ring-indigo-300">
                            ...
                            <div x-cloak x-show="open"
                                ...
                                <a href="{{ route('auth.register') }}"
                                   class="flex items-center gap-2 px-4 py-2 text-indigo-600 hover:bg-indigo-50 transition font-medium">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="md:hidden flex items-center gap-1">
                    ...
                    <a href="{{ route('tickets.my') }}"
                       class="flex items-center gap-1.5 px-2.5 py-2 rounded-xl
                              text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 transition text-xs font-medium">
            ...
            <div id="mobile-menu" class="md:hidden hidden border-t border-gray-100 py-3 space-y-0.5">
                @auth
                    <div class="flex items-center gap-3 px-3 py-2.5 mb-2">
                        <div class="w-9 h-9 rounded-full bg-indigo-100 flex items-center justify-center
                                    text-indigo-600 font-semibold text-sm shrink-0 overflow-hidden">
                            @if (Auth::user()->avatar)
                                <img src="{{ Auth::user()->avatar }}" class="w-full h-full object-cover">
                            @else
                                {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                ...
                @else
                    ...
                    <a href="{{ route('auth.register') }}"
                       class="flex items-center gap-3 px-3 py-2.5 text-sm text-indigo-600 font-medium hover:bg-indigo-50 rounded-xl transition">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                        </svg>
