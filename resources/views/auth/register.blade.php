    ...
    <form method="POST" action="{{ route('auth.register.store') }}" class="space-y-4">
        ...
        <div class="relative my-4">
            ...
            <div class="relative flex justify-center text-xs text-gray-400">
                <span class="bg-white px-3">ou continue com</span>
            </div>
        </div>

        <a href="{{ route('auth.google.redirect') }}"
            class="flex items-center justify-center gap-3 w-full py-3 border border-gray-200
          rounded-xl hover:bg-gray-50 transition text-sm font-medium text-gray-700">
