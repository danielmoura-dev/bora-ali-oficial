...
<a href="{{ route('events.show', $event->slug) }}"
   class="group flex flex-col bg-white rounded-2xl overflow-hidden border border-gray-100
          hover:border-indigo-100 hover:shadow-lg hover:-translate-y-0.5
    ...
    <div class="flex flex-col flex-1 p-4 gap-2">
        ...
        {{-- Data --}}
        <div class="flex items-center gap-1.5 text-xs text-indigo-600 font-medium">
        ...
        <div class="border-t border-gray-100 mt-auto pt-2 flex items-center justify-between">
            ...
            {{-- Seta --}}
            <svg class="w-3.5 h-3.5 text-gray-300 group-hover:text-indigo-400 shrink-0 transition-colors"
