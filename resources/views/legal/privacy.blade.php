            ...
            <div class="space-y-6 text-sm text-gray-600 leading-relaxed">
                ...
                <section>
                    ...
                    <ul class="list-disc pl-5 space-y-1">
                        <li><strong class="text-gray-700">Dados de cadastro:</strong> nome, e-mail, CPF ou CNPJ, data de
                            nascimento e número de celular</li>
                        <li><strong class="text-gray-700">Dados de pagamento:</strong> processados diretamente pelo gateway
                            de pagamento — não armazenamos dados de cartão</li>
                        <li><strong class="text-gray-700">Dados de uso:</strong> eventos criados, ingressos comprados e
                            histórico de transações</li>
                        <li><strong class="text-gray-700">Dados técnicos:</strong> endereço IP, tipo de navegador e
                            dispositivo</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <ul class="list-disc pl-5 space-y-1">
                        <li><strong class="text-gray-700">Organizadores:</strong> nome e e-mail do comprador são
                            compartilhados com o organizador do evento para fins de check-in</li>
                        <li><strong class="text-gray-700">Gateways de pagamento:</strong> Mercado Pago e/ou Pagar.me para
                            processar transações</li>
                        <li><strong class="text-gray-700">Obrigação legal:</strong> quando exigido por lei ou ordem judicial
                        </li>
                    </ul>
                ...
                <section>
                    ...
                    <ul class="list-disc pl-5 space-y-1">
                        <li>
                            <strong class="text-gray-700">Cookies essenciais:</strong>
                            necessários para o funcionamento da plataforma, como
                            manutenção da sessão de login e segurança. Não podem ser desativados.
                        </li>
                        <li>
                            <strong class="text-gray-700">Cookies de análise:</strong>
                            utilizamos o Google Analytics para entender como os usuários
                            interagem com a plataforma. Você pode recusar esses cookies
                ...
                <section>
                    ...
                    <p class="mt-2">
                        ...
                        <a href="mailto:privacidade@boraali.com.br" class="text-indigo-600 hover:underline">
